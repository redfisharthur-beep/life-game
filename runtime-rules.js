...
const replacements = [
  ...
  ['  room.game.stockPrice = round2(room.game.stockPrice * (stockUp ? 1.10 : 0.93));', '  room.game.stockPrice = round2(room.game.stockPrice * (stockUp ? 1.15 : 0.92));'],
  ...
  ['  return `${stockUp ? \'股票上漲 10%\' : \'股票下跌 7%\'}，${landUp ? \'土地上漲 3%\' : \'土地下跌 3%\'}`;', '  return `${stockUp ? \'股票上漲 15%\' : \'股票下跌 8%\'}，${landUp ? \'土地上漲 4%\' : \'土地下跌 4%\'}`;'],
  [
