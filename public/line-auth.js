(() => {
  ...
  style.textContent = `
    ...
    .line-auth-wrap{position:absolute;right:25%;bottom:36%;width:46px;height:46px;z-index:10001;pointer-events:auto}
    ...
    @media(max-width:640px){.line-auth-wrap{right:25%;bottom:36%;width:42px;height:42px}.line-icon-btn{width:42px;height:42px}.line-icon-btn svg{width:27px;height:27px}}
  `;
