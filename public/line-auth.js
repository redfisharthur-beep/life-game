(() => {
  ...
  style.textContent = `
    ...
    .line-auth-wrap{position:absolute;left:calc(18% + 100px);bottom:calc(7.5% + 50px);width:46px;height:46px;z-index:10001;pointer-events:auto}
    ...
    @media(max-width:640px){.line-auth-wrap{left:calc(17% + 100px);bottom:calc(7% + 50px);width:42px;height:42px}.line-icon-btn{width:42px;height:42px}.line-icon-btn svg{width:27px;height:27px}}
  `;
